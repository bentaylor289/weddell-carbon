...
%%% I modified this to work with DON instead of DIC. Then I multiply the output by a constant. 
...
save('LayerwiseTest'+string(tf)+'DON.mat', 'VH1_y','VH2_x','VH3_y', 'N1_y', 'N2_x', 'N3_y','Area1','Area2','Area3','NVH1','NVH2','NVH3', 'cont1' , 'cont2' , 'cont3','NVHtot', 'OVRtot', 'REStot', 'VOLtot')
